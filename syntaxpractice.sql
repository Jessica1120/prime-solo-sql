...
-- 8.   Add a new record.
    --INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('bob', 'new orleans', 3, 4, 120.00);
...
--9. The bank is losing money in Miami and Phoenix and needs to unload low transaction customers: Delete users that reside in miami OR phoenix and have completed fewer than 5 transactions.
    -- DELETE * FROM syntax-practice WHERE city='miami' or 'phoenix' AND transactions_completed < 5;